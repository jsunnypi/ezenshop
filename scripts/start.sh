...
PROJECT_FULL_PATH="/home/ec2-user/app/step1"
...
sudo nohup java -jar -Dspring.config.location=classpath:/application.properties,/home/ec2-user/app/application-real.properties $JAR_FILE > $APP_LOG 2> $ERROR_LOG &
