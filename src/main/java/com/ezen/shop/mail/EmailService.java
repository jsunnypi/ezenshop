...
public class EmailService {
    ...
    private final JavaMailSender mailSender; // EmailConfig.java파일의 mailSender bean 객체가 주입.	 G-Mail SMTP 메일 서버 정보
    ...
    // 단순 메시지를 포함한 메일 발송
    // String message : 메일에 보낼 내용(회원 가입시 메일인증코드, 임시비밀번호 등등)
    // String type : message 변수가 사용 될 템플릿 html 파일 이름. mail 폴더 확인
    public void sendMail(String type, EmailDTO dto, String message) {
    	// String htmlContent : message 변수의 내용을 템플릿 html 파일에 적용했을 때 결과 html code가 들어있음
