...
public class ReviewController {
	...
	@GetMapping("/rev_list/{pro_num}/{page}")  // /rev_list/1/1
	...
	// jackson databind 라이브러리가 json 기능 제공
	...
	// 수정하기. @RequestBody : 클라이언트에서 전송한 json 데이터를 ReviewVO vo로 변환하는 기능
