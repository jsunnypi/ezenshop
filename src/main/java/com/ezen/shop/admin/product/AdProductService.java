...
public class AdProductService {
	...
	public List<ProductVO> pro_list(SearchCriteria cri, String cate_code, String period, String start_date, String end_date) {
		return adProductMapper.pro_list(cri, cate_code, period, start_date, end_date);
	}
	
	public int getTotalCount(SearchCriteria cri, String cate_code, String period, String start_date, String end_date) {
