...
import com.ezen.shop.payment.PaymentService;
...
public class AdOrderController {
	...
	public void orderdetail_info(Integer ord_code, Model model) throws Exception {
		...
		// 주문한 상품 개수(종류)
		model.addAttribute("ord_product_size", order_product_info.size());
	...
	public ResponseEntity<String> order_product_del(Integer ord_code, Integer pro_num, int ord_product_size) throws Exception {
		ResponseEntity<String> entity = null;
		
		adOrderService.order_product_del(ord_code, pro_num, ord_product_size);
